   ...
   * ***************************************************** *
       ...
       *do "$endline_doImp/dofile1.do" //Give your dofile a more informative name, this is just a place holder name
   ...
   * ***************************************************** *
       ...
       *do "$endline_doImp/dofile2.do" //Give your dofile a more informative name, this is just a place holder name
   ...
   * ***************************************************** *
       ...
       *do "$endline_doImp/dofile3.do" //Give your dofile a more informative name, this is just a place holder name
